...
def build_graph():
    ...
    workflow.add_node("data_validator", data_validation_agent)
    workflow.add_node("price_analyzer", budget_agent)
    workflow.add_node("recommendation_explainer", recommendation_explanation_agent)
    workflow.add_node("report_generator", risk_and_report_agent)

    workflow.add_edge(START, "coordinator")
    workflow.add_edge("coordinator", "web_scraper")
    workflow.add_edge("web_scraper", "data_validator")
    workflow.add_edge("data_validator", "price_analyzer")
    workflow.add_edge("price_analyzer", "recommendation_explainer")
    workflow.add_edge("recommendation_explainer", "report_generator")
